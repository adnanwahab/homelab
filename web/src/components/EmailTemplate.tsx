...
export default function Map() {
  return (
    <div aria-hidden="true" className="relative size-full">
      ...
      <h1>hi</h1>
<img src="/screenshot_per_day.png" alt="Resend Logo" />
<img src="https://raw.githubusercontent.com/adnanwahab/homelab/refs/heads/main/web/public/Infinite.gif" alt="Resend Logo" />
    </div>
  )
}
