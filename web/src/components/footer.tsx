const navigation = {
  main: [
    // { name: 'Demo', href: '/dynabot' },
    { name: 'Buy Robot', href: '/dynabot/robot' },
    // { name: 'Dynamicland + How', href: '/dynabot/micro-dynamicland' },

    { name: 'Free Wiki-Course', href: '/dynabot/wikicourse' },
    // { name: 'Blog', href: '/articles/dynamicland' },
  ...
  //   {
  //     name: 'Instagram',
  //     href: 'https://www.instagram.com/dynabot.dev/',
  //     icon: (props) => (
  //       <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  //         <path
  //           fillRule="evenodd"
