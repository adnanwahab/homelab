...
const Iframes = (
  <div className="space-y-4">
    <h2 className="text-xl font-semibold">
      Scripts hosted + clickable + logging + dockerized
    </h2>
    ...
    <div className="grid grid-cols-2 gap-4 h-[600px]">
      ...
      <div>
        ...
        <iframe
          src="https://adnan-all-series.jerboa-kokanue.ts.net/"
          className="w-full h-full border rounded-lg"
        ></iframe>
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-4 h-[600px]">
      <iframe
        src="https://jupyter.hashirama.blog"
        className="w-full h-full border rounded-lg"
      ></iframe>
    </div>

    <p>
      This is a magic iframe that allows you to run any website on the GPU. And
      it has uptime for 3 Gpus.
    </p>
  </div>
);
...
function PersonalDashboard() {
  return (
    <>
      ...
      <iframe
        src="https://rescuetime.com/dashboard"
        className="w-full h-full border rounded-lg"
      ></iframe>
    </>
  );
