        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-4xl sm:text-center">
                    <h2 className="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-balance sm:text-6xl">Learn-math.app  / hashirama.com</h2>
                    <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">7 games to learn <ul><li>1. paper mario / (jolt 3js physics webgpu css3)</li><li> 2. notion / observablhq (markdown to diagram) </li> <li> 3. diagram to collaboratively align maurice(innate.bot)</li></p>
                </div>
            </div>
        </div>
    )
...
//               <p className="mt-2 max-w-lg text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">Everything you need to deploy your app</p>
...
//                     <img className="h-80 object-cover object-left" src="https://tailwindui.com/plus/img/component-images/bento-02-releases.png" alt="">
//                     <div className="p-10">
...
//                     <img className="h-80 object-cover" src="https://tailwindui.com/plus/img/component-images/bento-02-integrations.png" alt="">
//                     <div className="p-10">
...
//                       <p className="mt-2 max-w-lg text-sm/6 text-gray-400">Curabitur auctor, ex quis auctor venenatis, eros arcu rhoncus massa.</p>
//                     </div>
//                   </div>
//                 </div>
//                 <div className="flex p-px lg:col-span-2">
//                   <div className="overflow-hidden rounded-lg bg-gray-800 ring-1 ring-white/15 lg:rounded-bl-[2rem]">
//                     <img className="h-80 object-cover" src="https://tailwindui.com/plus/img/component-images/bento-02-security.png" alt="">
//                     <div className="p-10">
...
//                     <span className="text-5xl font-semibold tracking-tight text-gray-900">$1.00</span>
