    ...
    <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div>
            <h1 className="text-3xl font-bold text-blue-900">Adnan Wahab</h1>
          </div>
        </div>
      ...
      <div className="mt-8 space-y-8">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold text-blue-900">Zoox</h2>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold text-blue-900">Samasource</h2>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold text-blue-900">Consulting</h2>
              <span className="text-gray-500">2012-2021</span>
            </div>
            <ul className="list-disc list-inside space-y-2 mt-2 text-gray-700">
              <li>Sony, Blink Health, AMEX, Facebook Video</li>
              <li>
                2015 Famo.us -
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a className="text-blue-900" href="https://dynabot.dev">
            ...
            <div className="p-4 border rounded-lg">
              <h3 className="font-medium text-blue-900">SXSW Create (2015-2016)</h3>
              <p className="text-gray-600">
                Featured presenter: Botparty.org - Educational robotics platform
              </p>
            </div>
            <div className="p-4 border rounded-lg">
              <h3 className="font-medium text-blue-900">PathGL (2014)</h3>
              <p className="text-gray-600">
                Open-source WebGL visualization library with 500+ GitHub stars
                {" "}
                <a 
                  href="https://www.youtube.com/watch?v=cTyBiqH2elU"
                  className="text-blue-500 hover:underline"
                  target="_blank"
        ...
        {/* Add this skills section after the Projects & Speaking section */}
        <div className="mt-8">
          <h2 className="text-xl font-semibold mb-4 text-blue-900">Skills</h2>
