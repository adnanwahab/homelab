...
export default function BlogPage() {
  return (
    <div>
      ...
      <div>
        renas friends excluded me during the pandemic. we met in person at hotel
        chantelle. so i resolved to spend the rest of my life correcting the
        algorithms that govern the behavior of the systems that control our
        lives.
      </div>
