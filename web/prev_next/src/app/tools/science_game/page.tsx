export default function () {
  return <>'gotta fix the joly phsics sorry bro'</>;
}
...
//   useEffect(() => {
//     let renderer, scene, camera, controls, stats, physics, position;
//     let boxes, spheres;
//     let intervalId;
...
//       );
//       // const { JoltPhysics } = await import(
...
//       // Periodically reposition some objects to drop them
