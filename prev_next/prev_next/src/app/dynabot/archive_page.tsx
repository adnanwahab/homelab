...
const pageData = {
  ...
  sales: {
    subheading: "Robotics Odyssey",
    heading: "Free Info-course to learn robotics at an accelerated rate.",
    cards: [
      {
        eyebrow: "one_extra_module",
        title: "one extra module",
        description: "This info course has 4 moduels and should have 30-60 demos -- "
      },
      // ... other cards data
    ]
  },
  ...
  return (
    <Container>
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        ...
        <BentoCard
          eyebrow="Percpetion"
          title="Camera Callibration and point clouds!!"
        ...
        <BentoCard
          eyebrow="Prediction"
          title="100 fun applied reasoning demos"
        ...
        <BentoCard
          ...
          title="Soldering, PCBs, physics, and more!"
...
export default function Home() {
  return (
    <div className="overflow-hidden">
      <Hero />
      <main>
        <Container className="mt-10 hidden">
          <LogoCloud />
        </Container>
