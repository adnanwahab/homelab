...
let games = [
  {
    name: "Music Game",
    imgsrc:
      "https://media4.giphy.com/media/3otPoo8NDLOmzvTJF6/giphy.gif?cid=6c09b9524cu16ebo4tsyoifh0dxzoiho2unj1os0ytb9wxf1&ep=v1_gifs_search&rid=giphy.gif&ct=g",
          ...
          >
            <Link href={item.link}>
              ...
              <div style={{ padding: "15px" }}>
                <h3 className="text-blue-500" style={{ margin: "0 0 10px 0" }}>
                  {item.name}
                </h3>
                <p style={{ margin: "0", color: "#666" }}>{item.type}</p>
              </div>
            </Link>
          </div>
        ))}
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", width: "100vw", height: "100vh" }}>
        <div style={{ width: "50%", height: "100%" }}>Hello World</div>
