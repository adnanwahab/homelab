...
//add a file ccalled agents - 1000 in util folder?


function rich_hickey_problem_understander() {

}

function kent_beck_robustness() {}

function walter_isaacson_storyteller() {
  //raytrace email

// big 5 perosnality
// ennegrams 
// corpus callosum
// world transfomring mind 
// levels of energy
}
...
console.log(`Response took ${elapsedMs}ms (${elapsedMs/1000} seconds)`)
console.log(response.message.content)

//10ms 

//logrocket  + all (linux details from terminal) -> llama -> ?
//codium, modal, embeded/systems jobs


//chatGPT - 15 seconds
//ollama - 6 seconds on a macbook m2

//6000 / 600 = 10


console.log('want to get ollama 600 times faster')
import { serve } from "bun";

serve({
  port: 3000,  // Expose Jupyter Notebook via port 3000
  fetch(req) {
    return new Response("Hello, world!");
    // Proxy to Jupyter running on localhost:8888
    return fetch("http://127.0.0.1:8888" + new URL(req.url).pathname, {
      method: req.method,
      headers: req.headers,
      body: req.body
    });
...
console.log("Jupyter Notebook is now accessible at http://localhost:3000");
